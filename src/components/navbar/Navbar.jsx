...
class Navbar extends Component {
    ...
    render() {
        ...
        return (
            <div className={`navbar_container ${themeChage ? 'bg-[#202c37] text-[#ffffff]' : 'bg-[#ffffff] text-[#202c37]'} sticky top-0 z-[1] shadow`}>
                <nav className={`flex  text-[1.2rem] justify-between items-center px-12 h-14`} >
                    <div className="heading">
                        <h1 className='first-letter:capitalize font-bold worl'>where in the world?</h1>
                    </div>
